            ...
            <div class="col-lg-4 order-lg-2 order-2">
                <div class="page-sidebar-content-wrapper page-sidebar-right small-mt__40 tablet-mt__40">
                    ...
                    <div class="sidebar-widget widget-images wow move-up">
                        ...
                        <img class="img-fluid" src="{{asset ('assets/images/blog/blog-sidebar-ads.jpg')}}" alt="">
                ...
                <div class="main-blog-wrap">
                    ...
                    <div class="single-blog-item">
                        ...
                        <div class="post-feature blog-thumbnail  wow move-up">
                            <img class="img-fluid" src="{{asset ('assets/images/blog/blog-07-770x400.jpg')}}" alt="Blog Images">
                        </div>
                        <!-- Post Feature End -->
                        ...
                        <div class="post-info lg-blog-post-info  wow move-up">
                            ...
                            <div class="post-meta mt-20">
                                <div class="post-author">
                                    <a href="#">
                                        <img class="img-fluid avatar-96" src="{{asset ('assets/images/team/admin.jpg')}}" alt=""> Harry Ferguson
                                    </a>
                                </div>
                                <div class="post-date">
                                ...
                                <div class="entry-author">
                                    <div class="author-info">
                                        <div class="author-avatar">
                                            <img src="{{asset ('assets/images/team/avatar-06-90x90.jpg')}}" alt="">
                                ...
                                <div class="related-posts-wrapper">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            ...
                                            <a class="single-valid-post-wrapper" href="#">
                                                <div class="single-blog__item">
                                                    <div class="single-valid__thum bg-img" data-bg="{{asset ('assets/images/blog/blog-03-370x120.jpg')}}">
                                                    </div>
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <a class="single-valid-post-wrapper" href="#">
                                                <div class="single-blog__item">
                                                    <div class="single-valid__thum bg-img" data-bg="{{asset ('assets/images/blog/blog-05-370x120.jpg')}}">
                                                    </div>
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <ol class="comment-list">
                                                <li class="comment border-bottom">
                                                    <div class="comment-2">
                                                        <div class="comment-author vcard">
                                                            <img alt="" src="{{asset ('assets/images/team/coment.jpg')}}">
                                                        </div>
                                                ...
                                                <li class="comment border-bottom">
                                                    <div class="comment-2">
                                                        <div class="comment-author vcard">
                                                            <img alt="" src="{{asset ('assets/images/team/comment-2.jpg')}}">
                                                        </div>
                                                        <div class="comment-content">
                                                            <div class="meta">
                                                ...
                                                <li class="comment">
                                                    <div class="comment-5">
                                                        <div class="comment-author vcard">
                                                            <img alt="" src="{{asset ('assets/images/team/comment-3.jpg')}}">
                                                        </div>
                                                        <div class="comment-content">
                                                            <div class="meta">
                                                    ...
                                                    <ol class="children">
                                                        <li class="comment ">
                                                            <div class="comment-6">
                                                                <div class="comment-author vcard">
                                                                    <img alt="" src="{{asset ('assets/images/team/reply-comm.jpg')}}">
                                                                </div>
                                                                <div class="comment-content">
                                                                    <div class="meta">
