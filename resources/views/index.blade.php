            ...
            <div class="col-lg-6 col-md-6">
                <div class="infotechno-hero-inner-images">
                    <div class="infotechno-inner-one">
                        <img class="img-fluid" src="{{asset ('assets/images/hero/home-infotechno-main-slider-slide-01-image-01.png')}}" alt="">
                    </div>
                    <div class="infotechno-inner-two  wow move-up">
                        <img class="img-fluid" src="{{asset ('assets/images/hero/home-infotechno-main-slider-slide-01-image-02.png')}}" alt="">
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6 wow move-up">
                            ...
                            <div class="ht-box-images style-01">
                                <div class="image-box-wrap">
                                    <div class="box-image">
                                        <img class="img-fulid" src="{{asset ('assets/images/icons/mitech-box-image-style-01-image-01-100x108.png')}}" alt="">
                                    </div>
                                    <div class="content">
                        ...
                        <div class="col-lg-4 col-md-6 wow move-up">
                            ...
                            <div class="ht-box-images style-01">
                                <div class="image-box-wrap">
                                    <div class="box-image">
                                        <img class="img-fulid" src="{{asset ('assets/images/icons/mitech-box-image-style-01-image-02-100x108.png')}}" alt="">
                                    </div>
                                    <div class="content">
                        ...
                        <div class="col-lg-4 col-md-6 wow move-up">
                            ...
                            <div class="ht-box-images style-01">
                                <div class="image-box-wrap">
                                    <div class="box-image">
                                        <img class="img-fulid" src="{{asset ('assets/images/icons/mitech-box-image-style-01-image-03-100x108.png')}}" alt="">
                                    </div>
                                    <div class="content">
                                ...
                                <div class="box-large-image__box">
                                    <div class="box-large-image__midea">
                                        <div class="images-midea">
                                            <img src="{{asset ('assets/images/box-image/blog-01-330x330.jpg')}}" class="img-fluid" alt="">
                        ...
                        <div class="col-lg-4 col-md-6  mt-30">
                            ...
                            <a href="#" class="box-large-image__wrap wow move-up">
                                <div class="box-large-image__box">
                                    <div class="box-large-image__midea">
                                        <div class="images-midea">
                                            <img src="{{asset ('assets/images/box-image/mitech-home-infotechno-box-large-image-02-330x330.jpg')}}" class="img-fluid" alt="">
                        ...
                        <div class="col-lg-4 col-md-6  mt-30">
                            ...
                            <a href="#" class="box-large-image__wrap wow move-up">
                                <div class="box-large-image__box">
                                    <div class="box-large-image__midea">
                                        <div class="images-midea">
                                            <img src="{{asset ('assets/images/box-image/mitech-home-infotechno-box-large-image-03-330x330.jpg')}}" class="img-fluid" alt="">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="section-title-wrap text-center section-space--mb_40">
                    ...
                    <h3 class="heading">Why do people <span class="text-color-primary">love Mitech?</span></h3>
                </div>
                        ...
                        <div class="swiper-wrapper testimonial-slider__wrapper">
                                ...
                                <div class="testimonial-slider__one wow move-up">
                                    ...
                                    <div class="testimonial-slider--info">
                                        <div class="testimonial-slider__media">
                                            <img src="{{asset ('assets/images/testimonial/mitech-testimonial-avata-02-90x90.jpg')}}" class="img-fluid" alt="">
                                        </div>
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-slider__one wow move-up">
                                    ...
                                    <div class="testimonial-slider--info">
                                        <div class="testimonial-slider__media">
                                            <img src="{{asset ('assets/images/testimonial/mitech-testimonial-avata-03-90x90.jpg')}}" class="img-fluid" alt="">
                                        </div>
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-slider__one wow move-up">
                                    ...
                                    <div class="testimonial-slider--info">
                                        <div class="testimonial-slider__media">
                                            <img src="{{asset ('assets/images/testimonial/mitech-testimonial-avata-04-90x90.jpg')}}" class="img-fluid" alt="">
                                        </div>
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-slider__one wow move-up">
                                    ...
                                    <div class="testimonial-slider--info">
                                        <div class="testimonial-slider__media">
                                            <img src="{{asset ('assets/images/testimonial/mitech-testimonial-avata-01-90x90.jpg')}}" class="img-fluid" alt="">
                                        </div>
                ...
                <div class="resources-right-box">
                    <div class="resources-right-inner text-center">
                        <div class="resources-images">
                            <img class="img-fluid" src="{{asset ('assets/images/banners/managed-it-services-book-cover.png')}}" alt="">
                        </div>
                    </div>
                </div>
            </div>
